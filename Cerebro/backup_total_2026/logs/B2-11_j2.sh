...
OUT="$WS/Cerebro/backup_total_2026/logs/B2-11.j2.stdout"
echo "[$(date '+%F %T')] INICIANDO: B2-11 (Cerebro -> B2, janela 2, 25 min, multi-thread OFF — retry do arquivo em churn do rc=6 da J1)" >> "$OUT"
