#!/bin/bash
# J3: Dados_Frios continua (J2 rc=124 normal); novo livro ja fechado rc=0 na J1/J2 — fica fora desta janela
WS="/home/migueldorosario/Downloads/Antigravity Google"
LOG="$WS/Cerebro/backup_total_2026/logs/B2-15.log"
OUT="$WS/Cerebro/backup_total_2026/logs/B2-15.j3.stdout"
echo "[$(date '+%F %T')] INICIANDO: B2-15 J3 (Dados_Frios -> B2, multi-thread OFF)" >> "$OUT"
...
echo "[$(date '+%F %T')] TERMINADO: B2-15 J3 (rc=$RC)" >> "$OUT"
echo "EXIT=$RC" >> "$OUT"
exit $RC
