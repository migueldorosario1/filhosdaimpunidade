...
OUT="/home/migueldorosario/Downloads/Antigravity Google/Cerebro/backup_total_2026/logs/C15.j10.stdout"
FAIL=0
echo "[$(date '+%F %T')] INICIANDO: Dados_Frios (retomada J10)" >> "$OUT"
