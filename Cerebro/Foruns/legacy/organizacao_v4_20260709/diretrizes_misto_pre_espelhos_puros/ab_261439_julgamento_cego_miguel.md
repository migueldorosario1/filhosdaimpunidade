# Julgamento cego — 261439

Instrução: leia os dois textos abaixo sem consultar os JSONs ou o arquivo de auditoria. Escolha o melhor texto editorialmente e diga por quê. O objetivo é avaliar tese, interesse público, clareza, força jornalística e promessa ao leitor, não adivinhar qual versão é qual.

## Texto Laranja

**Título:** Tarifa dos EUA transforma Trump em problema eleitoral para Flávio Bolsonaro
