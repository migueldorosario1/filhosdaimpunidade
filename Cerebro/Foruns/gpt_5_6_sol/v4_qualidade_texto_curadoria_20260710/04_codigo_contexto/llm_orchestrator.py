...
DEFAULT_ORCHESTRATION_CONTRACT = "contratos/v4_orquestracao_llm_v1.json"
DEFAULT_PROVIDERS = "config/llm_providers.json"
DEFAULT_RATINGS = "config/llm_ratings.json"
