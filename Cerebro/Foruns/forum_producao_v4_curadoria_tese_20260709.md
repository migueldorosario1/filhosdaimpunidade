...
```text
Nao existe mais diretorio Cerebro/Foruns/v4/.
Cerebro/Foruns/ contem apenas foruns, cartas e docs leves.
Arquivos de trabalho V4 ficam em Projeto Cafezinho Agentes/root/v4_labs/.
```
...
Material de trabalho/auditoria tecnica para Fable/GPT 5.5/AGY:
...
Nao usar instrucoes historicas abaixo que apontem para `Cerebro/Foruns/v4/diretrizes/`, `Cerebro/Foruns/v4/pacotes/` ou `Cerebro/Foruns/v4/auditoria/`; esses espelhos/pacotes foram removidos ou arquivados. A auditoria corrente usa `Projeto Cafezinho Agentes/root/v4_labs/`.
...
Laboratorio para auditoria externa:
...
```text
Arquivos canonicos ficam em diretrizes/, v4_diretrizes/ e v4_data/, com copia de teste em Projeto Cafezinho Agentes/root/v4_labs/.
Cerebro/Foruns/ contem apenas discussao, cartas e docs leves. Nao recriar Cerebro/Foruns/v4.
```
