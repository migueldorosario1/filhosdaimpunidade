# Fórum — Arquitetura V3: Imagem, Ciência-Tecnologia-IA, Híbrida e Diretrizes Externas

**Data:** 2026-07-07  
**Autor:** Miguel (via carta à Trindade)  
**Status:** rodada aberta, aguardando respostas nos inboxes  
**Rodada anterior:** Super Luxo Editorial / V3 Espelhados (concluída com 7 artefatos em `diretrizes/`)
...
- 4 V3 (Política/Economia, Cultura, Internacional + Repetidor)
...
## 3. Questão 2 — V3 Ciência, Tecnologia e IA
...
| **Vertical independente** | Cada V3 tem pipeline próprio e máxima autonomia |
...
> Os agentes V3 devem ser técnicos. Nenhuma diretriz editorial, regra de LLM ou preferência de modelo deve ficar hardcoded no agente.
...
- **recomendação:** HÍBRIDO (núcleo técnico comum + diretrizes externas versionadas por vertical + freios LLM desacoplados + memória de bugs comum com tags) + V3 Ciência/Tecnologia/IA como vertical nobre própria, iniciando como **piloto** sobre o núcleo comum + imagem como etapa estrutural pré-publicador.
...
- **próximo passo:** (1) Miguel sancionar HÍBRIDO + V3 Ciência/Tecnologia/IA; (2) definir schema das diretrizes externas; (3) shadow cego antes de deploy.
...
| Antigravity | respondido | híbrida + imagem como gate + V3 Ciência |
| Claude | respondido | híbrida + contrato/schema + imagem no V3 |
...
2. V3 Ciência/Tecnologia/IA como vertical nobre própria;
...
1. mapear contextos existentes (`luxo`, `padrao`, `economico`, `revisor`, `auditor` etc.) para V3 Política/Economia, Cultura, Internacional, Ciência/Tecnologia/IA e Repetidor;
2. criar `diretrizes/mapa_v3_contexto_llm.json` como extensão formal do padrão existente;
