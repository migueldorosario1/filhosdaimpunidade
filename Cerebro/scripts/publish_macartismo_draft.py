...
image_path = "/home/migueldorosario/.gemini/antigravity/brain/d36006fd-19fa-4b43-b388-2a424d0f3dc3/mccarthyism_cartoon_1784647657522.png"

media_id = None
if os.path.exists(image_path):
    headers = {
        "Content-Disposition": "attachment; filename=carton_macartismo_americano.png",
        "Content-Type": "image/png"
    }
    with open(image_path, "rb") as f:
        res_media = requests.post(url_media, auth=auth, headers=headers, data=f)
    print("Media upload status:", res_media.status_code)
...
res_post = requests.post(url_posts, auth=auth, json=payload)
print("Post creation status:", res_post.status_code)
if res_post.status_code in (200, 201):
    ...
    print("Error creating draft:", res_post.text)
