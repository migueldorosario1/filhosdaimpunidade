...
2. Preserve a integridade factual dos eventos descritos.`;
      ...
      try {
        if (engineKey === 'glm52') {
          ...
          const glmModels = ['glm-4-plus', 'glm-4', 'glm-4-flash'];
          let lastErr = '';
          ...
          const dsModels = ['deepseek-reasoner', 'deepseek-chat'];
          let lastErr = '';
          ...
          return { error: lastErr || 'Resposta inválida da API DeepSeek' };
          ...
          return { error: lastErr || 'Resposta inválida da API Kimi 3.5' };
          ...
          const gptModels = ['gpt-4o', 'gpt-4o-2024-08-06', 'gpt-4o-mini'];
          let lastErr = '';
      ...
      try {
        ...
        Object.keys(dataset).forEach(chapKey => {
          ...
          if (savedContent && savedContent.trim().length > 0) {
            ...
            if (savedContent.includes('Revisão Aplicada') || savedContent.includes('${dateStr}') || savedContent.includes('${currentEngineName}')) {
